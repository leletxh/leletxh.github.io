...
<span class="line">    image: ghcr.io/leletxh/cabm:latest</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用外部数据库" tabindex="-1"><a class="header-anchor" href="#使用外部数据库"><span>使用外部数据库</span></a></h3><p>如果你有外部 Redis 或其他数据库服务：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token comment"># 在 .env 文件中添加数据库配置</span></span>
<span class="line"><span class="token builtin class-name">echo</span> <span class="token string">&quot;REDIS_URL=redis://your-redis-host:6379&quot;</span> <span class="token operator">&gt;&gt;</span> .env</span>
...
<span class="line">  <span class="token comment"># ... 其他参数</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="📋-环境变量详解" tabindex="-1"><a class="header-anchor" href="#📋-环境变量详解"><span>📋 环境变量详解</span></a></h2><h3 id="必需配置" tabindex="-1"><a class="header-anchor" href="#必需配置"><span>必需配置</span></a></h3><table><thead><tr><th>变量名</th><th>说明</th><th>示例值</th></tr></thead><tbody><tr><td><code>CHAT_API_BASE_URL</code></td><td>聊天 API 基础 URL</td><td><code>https://api.siliconflow.cn/v1</code></td></tr><tr><td><code>CHAT_API_KEY</code></td><td>聊天 API 密钥</td><td><code>sk-xxx</code></td></tr><tr><td><code>CHAT_MODEL</code></td><td>聊天模型名称</td><td><code>deepseek-ai/DeepSeek-V3</code></td></tr><tr><td><code>IMAGE_API_BASE_URL</code></td><td>图像 API 基础 URL</td><td><code>https://api.siliconflow.cn/v1</code></td></tr><tr><td><code>IMAGE_API_KEY</code></td><td>图像 API 密钥</td><td><code>sk-xxx</code></td></tr><tr><td><code>IMAGE_MODEL</code></td><td>图像模型名称</td><td><code>Kwai-Kolors/Kolors</code></td></tr></tbody></table><h3 id="可选配置" tabindex="-1"><a class="header-anchor" href="#可选配置"><span>可选配置</span></a></h3><table><thead><tr><th>变量名</th><th>说明</th><th>默认值</th></tr></thead><tbody><tr><td><code>PORT</code></td><td>应用端口</td><td><code>5000</code></td></tr><tr><td><code>HOST</code></td><td>绑定地址</td><td><code>0.0.0.0</code></td></tr><tr><td><code>DEBUG</code></td><td>调试模式</td><td><code>False</code></td></tr><tr><td><code>TTS_SERVICE_METHOD</code></td><td>TTS 服务方法</td><td><code>siliconflow</code></td></tr></tbody></table><h2 id="🔍-故障排除" tabindex="-1"><a class="header-anchor" href="#🔍-故障排除"><span>🔍 故障排除</span></a></h2><h3 id="镜像拉取失败" tabindex="-1"><a class="header-anchor" href="#镜像拉取失败"><span>镜像拉取失败</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token comment"># 检查网络连接</span></span>
...
<span class="line"><span class="token comment"># docker pull --platform linux/amd64 ghcr.io/leletxh/cabm:latest</span></span>
...
<span class="line">docker pull ghcr.io/leletxh/cabm:latest</span>
<span class="line"></span>
